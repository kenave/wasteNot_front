...
export default class VerticalSlider extends Component<Props, State> {
  ...
  _changeState(value: number): void {
    ...
    const ballHeight = ballIndicatorWidth ? ballIndicatorWidth : 64;
        ...
        {this.props.showBallIndicator ? (
          <Animated.View
            style={[
              ...
              styles.shadow,
              {
                width: ballIndicatorWidth ? ballIndicatorWidth : 64,
                height: ballIndicatorWidth ? ballIndicatorWidth : 64,
                borderRadius: ballIndicatorWidth ? ballIndicatorWidth / 2 : 32,
                bottom: this.state.ballHeight,
                left: ballIndicatorPosition ? ballIndicatorPosition : -80,
